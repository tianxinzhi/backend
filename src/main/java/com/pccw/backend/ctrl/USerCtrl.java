...
import com.pccw.backend.bean.user.CreateBean;
import com.pccw.backend.bean.user.EditBean;
import com.pccw.backend.bean.user.LoginBean;
import com.pccw.backend.bean.user.SearchBean;
...
@RequestMapping("user")
@Api(value="USerCtrl",tags={"user"})
public class USerCtrl extends BaseCtrl<DbResAccount> {

    @Autowired
    ResAccountRepository repo;

    @ApiOperation(value="创建用户",tags={"user"},notes="注意问题点")
    ...
    @ApiOperation(value="删除用户",tags={"user"},notes="注意问题点")
    @RequestMapping(method = RequestMethod.POST,value = "/delete")
    public JsonResult delete(@RequestBody BaseDeleteBean ids) {
        return this.delete(repo,ids);
    }

    @ApiOperation(value="修改用户",tags={"user"},notes="注意问题点")
    @RequestMapping(method = RequestMethod.POST,value = "/edit")
    public JsonResult edit(@RequestBody EditBean b) {
        return this.edit(repo, DbResAccount.class, b);
    }

    @ApiOperation(value="搜索用户",tags={"user"},notes="注意问题点")
    @RequestMapping(method = RequestMethod.POST,value = "/search")
    public JsonResult search(@RequestBody SearchBean bean) {
        return this.search(repo,bean);
    }

    @ApiOperation(value="用户登录",tags={"user"},notes="注意问题点")
