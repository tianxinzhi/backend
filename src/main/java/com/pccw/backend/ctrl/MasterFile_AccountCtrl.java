...
public class MasterFile_AccountCtrl extends BaseCtrl<DbResAccount> {
    ...
    @ApiOperation(value="创建用户",tags={"masterfile_account"},notes="注意问题点")
    ...
    @ApiOperation(value="删除用户",tags={"masterfile_account"},notes="注意问题点")
    @RequestMapping(method = RequestMethod.POST,value = "/delete")
    public JsonResult delete(@RequestBody BaseDeleteBean ids) {
        return this.delete(repo,ids);
    }

    @ApiOperation(value="修改用户",tags={"masterfile_account"},notes="注意问题点")
    @RequestMapping(method = RequestMethod.POST,value = "/edit")
    public JsonResult edit(@RequestBody EditBean b) {
        return this.edit(repo, DbResAccount.class, b);
    }

    @ApiOperation(value="搜索用户",tags={"masterfile_account"},notes="注意问题点")
