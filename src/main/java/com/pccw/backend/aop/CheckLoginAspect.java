...
public class CheckLoginAspect {
    ...
    //execution表达式自行搜索引擎
    @Pointcut("!execution(* com.pccw.backend.ctrl.Normal_ReserveCtrl.*(..)) && execution(* com.pccw.backend.ctrl.*.*(..)) && !execution(* com.pccw.backend.ctrl.SystemCtrl.*(..)) && !execution(* com.pccw.backend.ctrl.CommonCtrl.*(..))")
